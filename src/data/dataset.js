export const data = [
  ...
  },
  {
    ...
    name: "Short Circuit",
    shortDescription:
      "Un robot militar adquiere conciencia y busca la libertad.",
    description:
    ...
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/short-circuit.png",
    facts: {
      yearMovie: 1986,
  ...
  },
  {
    ...
    name: "The Martian",
    shortDescription:
      "Un astronauta lucha por sobrevivir en Marte con habilidades tecnológicas.",
    description:
      "Es una emocionante epopeya espacial basada en la novela de Andy Weir. Matt Damon interpreta a Mark Watney, un astronauta dejado atrás en Marte, desafiado a sobrevivir con recursos limitados. La película combina ciencia, ingenio y suspenso mientras Watney utiliza su ingenio para cultivar alimentos y comunicarse con la Tierra. Con un elenco estelar y efectos visuales asombrosos, The Martian captura la lucha humana por la supervivencia en el espacio, celebrando la tenacidad y el espíritu humano en la exploración interplanetaria.",
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/the-martian.jpeg",
    facts: {
      yearMovie: 2015,
  ...
  },
  {
    ...
    shortDescription:
      "Exploración de los impactos negativos de las redes sociales en la sociedad.",
    description:
      "Es un revelador documental dirigido por Jeff Orlowski que explora el impacto de las redes sociales en la sociedad contemporánea. Mediante testimonios de expertos en tecnología y ex empleados de grandes plataformas, la película destapa los peligros ocultos detrás de la manipulación algorítmica y la adicción digital. Ilustrando cómo estas plataformas explotan la atención y manipulan la información, The Social Dilemma plantea cuestionamientos esenciales sobre la privacidad, la polarización y el poder de la tecnología en la configuración de nuestras vidas cotidianas, ofreciendo una perspectiva inquietante y reflexiva sobre el precio de la conectividad moderna.",
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/the-social-dilemma.jpeg",
    facts: {
      yearMovie: 2020,
  ...
  },
  {
    ...
    name: "Ex Machina",
    shortDescription:
      "Exploración de la inteligencia artificial y la ética en su creación.",
    description:
    ...
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/ex-machina.jpeg",
    facts: {
      yearMovie: 2014,
  ...
  },
  {
    ...
    name: "The Net",
    shortDescription:
      "Una analista de sistemas se convierte en blanco de una conspiración informática.",
    description:
      "Es un thriller tecnológico que sigue la vida de Angela Bennett, interpretada por Sandra Bullock, una experta en sistemas que se encuentra atrapada en una red de conspiración. Después de recibir un disco con información confidencial, su identidad es eliminada, y se ve envuelta en una red de engaños y peligros en línea. La película, lanzada en 1995, anticipa cuestiones actuales sobre privacidad y ciberseguridad, proporcionando una visión fascinante y, a veces inquietante, de los riesgos asociados con la creciente dependencia de la tecnología y la conectividad.",
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/the-net.jpeg",
    facts: {
      yearMovie: 1995,
  ...
  },
  {
    ...
    name: "T&C may apply",
    shortDescription:
      "Implicaciones de aceptar términos y condiciones en línea.",
    description:
      "es un documental revelador que examina el precio de la privacidad en la era digital. A través de entrevistas y análisis detallados, la película destapa los términos y condiciones a menudo ignorados de servicios en línea y aplicaciones, destacando cómo las corporaciones tecnológicas recopilan y utilizan datos personales. Revelando los riesgos de la vigilancia masiva, el documental plantea preguntas críticas sobre la privacidad individual y la pérdida de control en un mundo cada vez más conectado, ofreciendo una perspectiva impactante sobre el trueque inadvertido de la privacidad por conveniencia digital.",
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/terms-and-conditions-may-apply.jpeg",
    facts: {
      yearMovie: 2013,
  ...
  },
  {
    ...
    name: "WarGames",
    shortDescription:
      "Un joven hacker desencadena una simulación de guerra global.",
    description:
      "Es un clásico de culto de los años 80 que fusiona la intriga tecnológica con la amenaza global. Matthew Broderick interpreta a David Lightman, un joven hacker que, sin saberlo, entra en el sistema de defensa nuclear de Estados Unidos mientras juega un videojuego. Lo que comienza como un inocente desafío se convierte en un tenso enfrentamiento internacional cuando el sistema interpreta sus acciones como una amenaza real. WarGames ofrece una mirada cautivadora a las implicaciones de la tecnología en la seguridad global, explorando la delgada línea entre juego y realidad.",
    imageUrl:
      "https://raw.githubusercontent.com/MilenaPacheco/DEV013-dataverse/main/src/img/wargames.png",
    facts: {
      yearMovie: 1983,
      directorMovie: "John Badham",
